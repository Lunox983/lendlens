...
--
-- Host: localhost:3306
-- Generation Time: Jul 16, 2026 at 01:02 PM
...
INSERT INTO `equipments` (`equipment_id`, `kit_code`, `name`, `category_id`, `equipment_img`, `total_quantity`, `description`, `usage_type`, `price`) VALUES
(1, 'Kit 01', 'iPad [kit] : 5th generation รุ่น Wi-Fi 32 GB', 1, 'uploads/equipments/kit01.webp', 10, 'California, C.A. : Apple, c2018. จัดซื้อในปีงบประมาณ พ.ศ. 2561', 'external', 12900.00),
(2, 'Kit 02', 'Quicktionary II professional [kit] : scan and translate text in seconds', 3, 'uploads/equipments/kit02.jpg', 7, 'วิทย์ เที่ยงบูรณธรรม. กรุงเทพฯ : บริษัท WizCom Technologies, c2548', 'external', 4500.00),
(3, 'Kit 04', 'iPod classic [kit]', 1, 'uploads/equipments/kit04.jpg', 8, 'Cupertino, C.A. : Apple, c2007. Mac or PC, USB 2.0, Mac OS X v10.4.8, Windows Vista or Windows XP Home or Professional (SP2), iTunes 7.4, Internet access', 'external', 3500.00),
(4, 'Kit 11', 'กระเป๋าใส่หนังสือ [kit]', 5, 'uploads/equipments/bagpsck.webp', 24, 'พิมพลักษณ์: 2552', 'external', 500.00),
(5, 'Kit 10', 'โคมไฟอ่านหนังสือ ยี่ห้อ Panasonic [kit]', 5, 'uploads/equipments/OIP.webp', 10, 'พิมพลักษณ์: 2552', 'internal', 350.00),
(6, 'Kit 13', 'ปลั๊กพ่วงสายไฟ [kit]', 5, 'uploads/equipments/toshimo.webp', 40, 'พิมพลักษณ์: 2552', 'internal', 250.00),
(7, 'Kit 16', 'หูฟังไร้สาย [headphones]', 4, 'uploads/equipments/headphone.webp', 32, 'พิมพลักษณ์: 2554', 'internal', 890.00),
(8, 'Kit 17', 'CyberDict 8 plus [kit]', 3, 'uploads/equipments/Read.jpg', 20, 'พจนานุกรมหลายภาษา -- อุปกรณ์อิเล็กทรอนิกส์. กรุงเทพฯ : บริษัทไซเบอร์ดิก เทคโนโลยี, 2554', 'external', 2500.00),
(9, 'Kit 20', 'iPad 2 [kit]', 1, 'uploads/equipments/ipad.jpeg', 7, 'Cupertino, C.A. : Apple, c2012. Wi-Fi 32GB Black, เชื่อมต่อกับ iTunes บน Mac หรือ PC ต้องการ iTunes 10.5 หรือใหม่กว่า จัดซื้อในปีงบประมาณ พ.ศ. 2555', 'external', 12900.00),
(10, 'Kit 21', 'Lightning to digital AV adapter [adapter] / Apple.', 2, 'uploads/equipments/USB-C.jpeg', 7, 'China : Apple, c2017.', 'internal', 1500.00),
(11, 'Kit 22', 'Acer projector [projector]', 5, 'uploads/equipments/acer.jpeg', 1, '[ไต้หวัน : เอเซอร์, ม.ป.ป.]', 'external', 5000.00),
(12, 'Kit 35', 'iPad air [kit]', 1, 'uploads/equipments/ipad_air.webp', 10, 'California, C.A. : Apple, c2014. สายจ่ายไฟ USB รองรับ Wi-Fi และบลูทูธ จัดซื้อในปีงบประมาณ พ.ศ. 2557', 'external', 15000.00),
(13, 'Kit 38', 'iPad [kit] : 7th generation รุ่น Wi-Fi 32 GB Silver.', 1, 'uploads/equipments/ipad_old.webp', 3, 'California, C.A. : Apple, c2019.', 'external', 10900.00),
(14, 'Kit 39', 'USB-C to digital AV : multiport adapter [adapter] / Apple.', 2, 'uploads/equipments/AV.jpg', 8, 'อะแดปเตอร์. Cupertino, CA : Apple, 2019.', 'internal', 2500.00),
(15, 'Kit 40', 'USB-C to HDMI adapter [adapter]', 2, 'uploads/equipments/HDMI.webp', 4, 'Adapters. China : Ugreen Group, [n.d.]', 'internal', 800.00),
(16, 'Kit 41', 'Light-weight headphones [headphones]', 4, 'uploads/equipments/ReadImage.jpeg', 3, 'Headphones. [Thailand] : [Synchro], [n.d.]', 'internal', 300.00),
(17, 'Kit 43', 'สายชาร์จโทรศัพท์ (Lightning) [adapter] / Apple.', 2, 'uploads/equipments/lightning.jpeg', 1, 'Adapters. China : Apple, [n.d.] สามารถใช้งานได้กับ Apple Watch, iPhone, หรือ iPod ทุกรุ่น', 'internal', 500.00),
(18, 'Kit 47', 'สายชาร์จโทรศัพท์ (Lightning) [adapter] / Apple.', 2, 'uploads/equipments/lightning_1.jpeg', 1, 'Adapters. China : Apple, [n.d.]', 'internal', 500.00),
(19, 'Kit 15', 'NEC projector [projector]', 5, 'uploads/equipments/NEC.webp', 3, 'Overhead projection. Motion picture projectors. Illinois : NEC Display Solutions, 2015.', 'external', 6000.00),
(20, 'Kit 45', 'สายชาร์จโทรศัพท์ (Type C) [adapter] / Apple.', 2, 'uploads/equipments/type_c.webp', 1, 'Adapters. China : Apple, [n.d.]', 'internal', 500.00),
(21, 'Kit 46', 'สายชาร์จโทรศัพท์ (Type C) [adapter] / Apple.', 2, 'uploads/equipments/type_c1.jpeg', 5, 'Adapters. China : Apple, [n.d.]', 'internal', 500.00),
(22, 'Kit 48', 'สายชาร์จโทรศัพท์ (Lightning) [adapter] / Apple.', 2, 'uploads/equipments/lightning_3.jpeg', 2, 'Adapters. China : Apple, [n.d.]', 'internal', 500.00),
(23, 'Kit 49', 'หูฟังแบบมีสาย : Hyperx cloud stinger 2 core [headphones]', 4, 'uploads/equipments/headphones_2.jpeg', 12, 'จีน ;นนทบุรี : บริษัทเอสเซนตี้ รีซอร์สเซส, 2023 [2566]', 'internal', 1590.00),
(24, 'Kit 42', 'เครื่องคิดเลข CASIO fx-350MS [calculator]', 3, 'uploads/equipments/calculator.jpeg', 5, 'เครื่องคำนวณเลข คาสิโอ. [S.I.] : [S.n.], [n.d.]', 'external', 450.00),
(25, 'Kit 50', 'ปลั๊กพวง USB + Type C [kit]', 2, 'uploads/equipments/USB_TYPEC.jpeg', 5, 'จีน ;กรุงเทพฯ : โตชิโน ซัพพลาย, 2567. แรงดันไฟฟ้าสูงสุด (Max voltage): 250 v., ค่ากระแสไฟฟ้าสูงสุด (Max current): 10 amp., กำลังไฟฟ้าสูงสุด (Max wattage): 2300 วัตต์', 'internal', 690.00),
(26, 'Kit 51', 'Stylus pen [kit]', 3, 'uploads/equipments/pen.jpeg', 3, 'ปากกา. จีน ;นนทบุรี : Remax (Thailand), [ม.ป.ป.]', 'internal', 590.00),
(27, 'Kit 52', 'Wireless mouse [kit]', 3, 'uploads/equipments/mouse.jpeg', 5, 'เวียดนาม : Logitech Asia Pacific, 2025. ข้อกำหนดของระบบ พอร์ต USB ใช้ได้กับ Windows 10, 11 หรือใหม่กว่า macOS 11 หรือใหม่กว่า ChromeOS Linux', 'internal', 490.00),
(28, 'Kit 53', 'เสื้อพับ [kit]', 5, 'uploads/equipments/no.1.jpeg', 6, '[ม.ป.ท. : ม.ป.พ., ม.ป.ป.]', 'internal', 0.00),
(29, 'Kit 44', 'สายชาร์จโทรศัพท์ (Lightning) [adapter] / Apple.', 2, 'uploads/equipments/kit44.jpeg', 2, 'Adapters. China : Apple, [n.d.] สามารถใช้งานได้กับ iPhone, iPad, iPod', 'internal', 500.00);
...
CREATE TABLE `fine_settings` (
  ...
  `fine_type` enum('overdue_per_day','damaged','lost') COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `equipments`
  ...
  ADD KEY `fk_equip_category_v2` (`category_id`);
...
--
ALTER TABLE `admin_activity_log`
  ADD CONSTRAINT `admin_activity_log_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`emp_id`);
...
--
ALTER TABLE `equipments`
  ADD CONSTRAINT `fk_equip_category` FOREIGN KEY (`category_id`) REFERENCES `equipment_categories` (`category_id`),
  ADD CONSTRAINT `fk_equip_category_v2` FOREIGN KEY (`category_id`) REFERENCES `equipment_categories` (`category_id`);
