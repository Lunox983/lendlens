    ...
    return (
        <>
            <div className="bg-white border-b border-purple-100 px-8 py-5 sticky top-0 z-10">
                <h1 className="text-xl font-semibold">รายการคืนและประวัติ</h1>
                <p className="text-[12.5px] text-slate-400 mt-0.5">ตรวจสอบสถานะการคืน และการจัดการค่าปรับ</p>
            </div>
                    ...
                    <div className="flex flex-wrap gap-3 mb-6 items-center pb-2">
                        <div className="flex gap-3 overflow-x-auto">
                            {[
                                ...
                                { id: "fine_paid", label: "จ่ายค่าปรับแล้ว" }
                            ].map(f => (
                                <button
                                    key={f.id}
